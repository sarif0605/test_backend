...
@section('content')
    ...
    <div class="container">
        <form id="content-form" class="p-4 card shadow-sm" action="{{ route('category.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <textarea id="editor" name="description" class="form-control" rows="8" placeholder="Tulis konten di sini">{{ old('description') }}</textarea>
                    @error('description')
                        <span class="text-danger small">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="card-footer text-center">
                <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                        <a href="{{ route('category') }}" class="btn btn-secondary w-100">
